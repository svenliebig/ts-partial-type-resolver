import {
	...
	EnumMember,
	Identifier,
	isArrayTypeNode, isIdentifier, isIntersectionTypeNode,
	isLiteralTypeNode,
	isStringLiteral, isTypeLiteralNode,
	isTypeReferenceNode,
	isUnionTypeNode, PropertyName, TypeAliasDeclaration
} from "typescript";
...
export class DeclarationFactory {
	...
	public static createTypeDeclaration(statement: TypeAliasDeclaration) {
		...
		if (isTypeReferenceNode(statement.type)) {
			if (isIdentifier(statement.type.typeName) &&
